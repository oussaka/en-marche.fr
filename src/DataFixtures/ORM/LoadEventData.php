...
class LoadEventData extends Fixture
{
    ...
    {
        $eventCategory1 = $this->getReference('event-category-1');
        $eventCategory2 = $this->getReference('event-category-2');
        $eventCategory3 = $this->getReference('event-category-3');
        $eventCategory5 = $this->getReference('event-category-5');
        $eventCategory6 = $this->getReference('event-category-6');
        $eventCategory9 = $this->getReference('event-category-9');
        $eventCategory10 = $this->getReference('event-category-10');
        $hiddenEventCategory = $this->getReference('event-category-16');
