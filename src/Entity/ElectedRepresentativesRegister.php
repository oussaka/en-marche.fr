...
use AppBundle\ElectedRepresentativesRegister\ElectedRepresentativesRegisterModel;
...
class ElectedRepresentativesRegister
{
    ...
    public static function createByModel(ElectedRepresentativesRegisterModel $electedRepresentativesRegisterModel): self
    {
        return self::create(
            $electedRepresentativesRegisterModel->departmentId,
            $electedRepresentativesRegisterModel->communeId,
            $electedRepresentativesRegisterModel->adherent,
            $electedRepresentativesRegisterModel->typeElu,
            $electedRepresentativesRegisterModel->dpt,
            $electedRepresentativesRegisterModel->dptNom,
            $electedRepresentativesRegisterModel->nom,
            $electedRepresentativesRegisterModel->prenom,
            $electedRepresentativesRegisterModel->genre,
            new \DateTime($electedRepresentativesRegisterModel->dateNaissance),
            $electedRepresentativesRegisterModel->codeProfession,
            $electedRepresentativesRegisterModel->nomProfession,
            $electedRepresentativesRegisterModel->dateDebutMandat,
            $electedRepresentativesRegisterModel->nomFonction,
            new \DateTime($electedRepresentativesRegisterModel->dateDebutFonction),
            $electedRepresentativesRegisterModel->nuancePolitique,
            $electedRepresentativesRegisterModel->identificationElu,
            $electedRepresentativesRegisterModel->nationaliteElu,
            $electedRepresentativesRegisterModel->epciSiren,
            $electedRepresentativesRegisterModel->epciNom,
            $electedRepresentativesRegisterModel->communeDpt,
            $electedRepresentativesRegisterModel->communeCode,
            $electedRepresentativesRegisterModel->communeNom,
            $electedRepresentativesRegisterModel->communePopulation,
            $electedRepresentativesRegisterModel->cantonCode,
            $electedRepresentativesRegisterModel->cantonNom,
            $electedRepresentativesRegisterModel->regionCode,
            $electedRepresentativesRegisterModel->regionNom,
            $electedRepresentativesRegisterModel->euroCode,
            $electedRepresentativesRegisterModel->euroNom,
            $electedRepresentativesRegisterModel->circoLegisCode,
            $electedRepresentativesRegisterModel->circoLegisNom,
            $electedRepresentativesRegisterModel->infosSupp,
            $electedRepresentativesRegisterModel->uuid,
            $electedRepresentativesRegisterModel->nbParticipationEvents,
            $electedRepresentativesRegisterModel->adherentUuid
        );
    }
